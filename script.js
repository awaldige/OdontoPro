document.addEventListener('DOMContentLoaded', () => {
  ...
  campoBusca.addEventListener('input', () => {
    ...
    paginaAtual = 1; // sempre voltar à página 1
    atualizarListaProdutos();
  });
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  carrinhoBtn.addEventListener('click', () => carrinho.toggleAttribute('hidden'));
  fecharCarrinho.addEventListener('click', () => carrinho.setAttribute('hidden', ''));
  ...
  function removerDoCarrinho(index) {
    itensCarrinho.splice(index, 1);
    atualizarCarrinho();
    if (itensCarrinho.length === 0) carrinho.setAttribute('hidden', '');
  }
  ...
  // Todos os produtos inicialmente
  let produtosFiltrados = Array.from(listaProdutosContainer.querySelectorAll(".produto"));
